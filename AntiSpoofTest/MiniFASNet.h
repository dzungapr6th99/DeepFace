...
namespace AntiSpoofing
{
	...
	/// </summary>
	MiniFASNet* MiniFASNetV1(int embedding_size = 128, std::vector<int64_t> conv6_kernel = { 7,7 }, float drop_p = 0.2, int num_classes = 3, int img_chanel = 3)
	{
	...
	/// </summary>
	MiniFASNet* MiniFASNetV2(int embedding_size = 128, std::vector<int64_t> conv6_kernel = { 7,7 }, float drop_p = 0.2, int num_classes = 3, int img_chanel = 2)
	{
		return new MiniFASNet(keep_dict["1.8M_"], embedding_size, conv6_kernel, drop_p, num_classes, img_chanel);
	}


	MiniFASNetSE* MiniFASNetV1SE(int embedding_size = 128, std::vector<int64_t> conv6_kernel = { 7,7 }, float drop_p = 0.2, int num_classes = 3, int img_chanel = 2)
	{
		return new MiniFASNetSE(keep_dict["1.8M"], embedding_size, conv6_kernel, drop_p, num_classes, img_chanel);

	}
	MiniFASNetSE* MiniFASNetV2SE(int embedding_size = 128, std::vector<int64_t> conv6_kernel = { 7,7 }, float drop_p = 0.2, int num_classes = 3, int img_chanel = 2)
	{
